...
public class AccountingInterfaceBusinessWorksNew implements AccountingInterface {
	
	final private static Logger logger = Logger.getLogger(AccountingInterfaceBusinessWorksNew.class.getName());
