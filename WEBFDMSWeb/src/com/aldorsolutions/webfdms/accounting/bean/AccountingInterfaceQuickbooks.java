...
/**
 * Workfile: AccountingInterfaceQuickbooks.java
...
public class AccountingInterfaceQuickbooks implements AccountingInterface {
	
	final private static Logger logger = Logger.getLogger(AccountingInterfaceQuickbooks.class.getName());
