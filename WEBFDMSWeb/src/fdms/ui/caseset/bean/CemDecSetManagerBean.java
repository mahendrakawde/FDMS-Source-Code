...
import fdms.ui.caseset.dao.CemDecCaseSetDAO;

public class CemDecSetManagerBean {
    ...
    public int getCaseCount(
        ...
        try {
        	CemDecCaseSetDAO caseDecSetDao = new CemDecCaseSetDAO( dbLookup );
            
            count = caseDecSetDao.getCaseCount(
                    locationId,
                    locationIds,
                    sortBy,
                    searchParam,
    ...
    public ArrayList getCaseList(
        ...
        try {
			CemDecCaseSetDAO casePropSetDao = new CemDecCaseSetDAO( dbLookup );

			cases = casePropSetDao.getCaseList(
					locationId, 
					locationIds,
					sortBy,
					((startIndex - 1) * limit), 
