...
public class ProcessFreeTrialRegistrationver1 extends Action {
    
    private Logger logger = Logger.getLogger(ProcessFreeTrialRegistrationver1.class.getName());
    ...
    public boolean checkLocationExists(com.aldorsolutions.webfdms.beans.DbLocation dbLocation, DbUserSession sessionUser) {
        ...
        try {
            t = new DatabaseTransaction(dbLookup, sessionUser);
    ...
    throws javax.servlet.ServletException, java.io.IOException 
	{
       ...
       // AppLog.info("ProcessFreeTrialRegistration.doPerform:Submit = " +submitType);
        ...
        // Make sure the registration form Free Trial Information data is valid before proceeding.
     ...
     */
    public void validateFuneralHomeInfo(fdms.ui.struts.form.FreeTrialRegistration form, ActionErrors errors, DbUserSession sessionUser) {
    ...
    public void validateUserInfo(fdms.ui.struts.form.FreeTrialRegistration form, ActionErrors errors) {
        ...
        try {
            ...
            //AppLog.trace("In ProcessFreeTrialRegistration.validateUserInfo");
