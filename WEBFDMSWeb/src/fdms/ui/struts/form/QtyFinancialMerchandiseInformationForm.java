...
public class QtyFinancialMerchandiseInformationForm extends QtyFinancialMerchandiseInformationFormBase {
	...
	public String[] getSerialItems() {
		return serialItems;
	}

	public void setSerialItems(String[] serialItems) {
