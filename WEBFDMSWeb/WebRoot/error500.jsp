...
<table width="100%" cellpadding="20" cellspacing="20" border="0" style="position: absolute; z-index: 200;">
  ...
  <tr>
    <td style="font-size: 13px; color: #990000; font-weight: bold; border: solid 1px #666666; background-color: #FFFFCC;" align="center">An error has occurred in FDMS Network. Should you continue to see this
        message, please contact the system administrator at <a href="mailto:info@davidsonsoftware.com">info@davidsonsoftware.com</a> 
