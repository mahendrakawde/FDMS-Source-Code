	...
	<body class="displayArea" onLoad="checkData(); copyLocaleName(); copyLocationName();">
		...
		<html:form action="/showCemList">
			...
			<logic:present name="caseList" scope="session">
				...
				<logic:iterate name="caseList" id="theCase" offset="beginCaseListCursor" length="endCaseListCursor">
					<div id="case<bean:write name='theCase' property='decID'/>" style="width:98%;margin-bottom:10px;position:relative;">
						<div class="expandBoxBar"
								onDblClick="expandCase(
									'case<bean:write name="theCase" property="decID"/>',
									'summary<bean:write name="theCase" property="decID"/>',
									'details<bean:write name="theCase" property="decID"/>',
									'expandButton<bean:write name="theCase" property="decID"/>'
									);"
							...
							<div style="float:left;padding-left:5px;">
								<span style="vertical-align:top;margin-top:2px;">
										...
										<bean:write name="theCase" property="lastName"/>
										(<bean:write name="theCase" property="firstName"/>)
						...
						<table 	id="summary<bean:write name='theCase' property='decID'/>"
									...
									<table style="width:100%;">
										...
										<tr>   
											...
											<td class="caseListValue" valign="top">
												<bean:write name="theCase" property="street"/>
									...
									<table style="width:100%;">
										...
										<tr>   
										   <td class="caseListLabel" nowrap valign="top">
											...
											<td class="caseListValue" valign="top">
												<bean:write name="theCase" property="city"/>
											</td>
										</tr>
									...
									<table style="width:100%;">
										...
										<tr>   
										   <td class="caseListLabel" nowrap valign="top">
											...
											<td class="caseListValue" valign="top">
												<bean:write name="theCase" property="state"/>	
											</td>
										</tr>
