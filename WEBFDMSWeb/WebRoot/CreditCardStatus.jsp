			...
			<tr>
				...
				<fieldset>
					<table width="100%" border="0" cellspacing="0" cellpadding="100">
						...
						<tr>
						   <td>Card Response</td>
						   <td><html:text maxlength="50" size="34" name="creditCardForm" property="responseCard"/></td>
						</tr>
						<tr>
						   <td>Pass/Fail Detail</td>
						   <td><html:text maxlength="50" size="34" name="creditCardForm" property="erorDetail"/></td>
						</tr>
						<tr>
						   <td>Approval Code</td>
						   <td><html:text maxlength="50" size="34" name="creditCardForm" property="approvalCode"/></td>
						</tr>
					</table>
				</fieldset>
				</td>
