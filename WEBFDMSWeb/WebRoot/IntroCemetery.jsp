...
<div id="mnuLayer" class="topMenu">
  <jsp:include page="topMenuCem.jsp"/>
</div>

<div id="P8TBtrig10" style="position:absolute; left: 20px; top: 60px; width: 60px; z-index: 300; visibility: visible; height: 21px;">
	<a href="showCemList.do" target="contentFrame" onFocus="if(this.blur)this.blur()" onMouseOver="P8_trigMM2('P8TBim10')">
...
<c:if test="${sessionScope.permissions.atNeedGranted}">
	<div id="P8TBtrig11" style="position:absolute; left: 82px; top: 60px; width: 90px; z-index: 300; visibility: visible; height: 21px;">
		<a href="newCemAtNeed.do" target="contentFrame" onFocus="if(this.blur)this.blur()" onMouseOver="P8_trigMM2('P8TBim11')">
  ...
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="boxborder">
    ...
    <tr>
      <td align="LEFT" valign="TOP" height="100%">
       <iframe src="showCemList.do" name="contentFrame" onload="javascript:isRedirected();" width="100%" height="100%" align="default" style="position: absolute; top: 1px; left: 20px;" frameborder="0" marginheight="0" marginwidth="0" scrolling="AUTO"></iframe> 
      </td>
    </tr>
    <tr>
      <td height="10">&nbsp;</td>
