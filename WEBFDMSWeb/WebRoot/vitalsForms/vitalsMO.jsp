...
<html:form action="/processVitals" name="vitals" type="fdms.ui.struts.form.VitalsForm">
	...
	<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#000000" bordercolordark="#000000">
		<tr>
			<td height="30" align="left" nowrap="nowrap" bordercolorlight="#000000" bordercolordark="#000000" class="pageTitle">
				Vital	Statistics
			</td>
		</tr>
		<tr>
			...
			<td>
				<fieldset>
					<legend class="tahoma12bBlue">Decedent Information</legend>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td width="49%" height="20" align="left" valign="top" class="verdana10">
									<fieldset>
										<legend class="tahoma12bGreen">Name and Gender</legend>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
											...
											<tr>
												<td height="28">
													<html:text maxlength="50" size="14" property="deceasedMaiden" />
													<html:text maxlength="50" size="10" property="decPrefix" />
													<html:text maxlength="50" size="10" property="deceasedSuffix" />
												</td>
											</tr>
											<tr>
												<td height="30" valign="bottom" class="verdana10"><strong>OTHER NAME USED FOR PERSONAL BUSINESS (First, Middle, Last, Prefix, Suffix)</strong></td>
											</tr>
											<tr>
												<td height="28"><html:text maxlength="15" size="14" property="aliasFirstName" />
                  ...
                  <td width="49%" align="left" valign="top" class="verdana10"><fieldset><legend class="tahoma12bGreen">Relevent Dates and Age</legend>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                    ...
                    <tr>
                      <td height="28">
                        ...
                        <input type="button" value="Calculate" onClick="javascript:calculateLastBirthdate();"> 	
                      </td>
                    </tr>
                    <tr>
              ...
              <html:option value=" ">   </html:option>
                  ...
                  <fieldset><legend class="tahoma12bGreen">Current Residence</legend>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="49%"><html:text maxlength="60" size="30" property="deceasedStreet" /></td>
                      </tr>
                      <tr>
                        <td align="right" valign="top" class="verdana10"><strong>LOCALITY (Check one box and specify)</strong></td>
                        <td>
                        	<span class="verdana10" style="line-height:28px">
	                          <html:checkbox property="localityInsideCity" />INSIDE CITY OR VILLAGE OF<br>
	                          <html:checkbox property="localityInsideTwp" />TWP OF<br>
	                          <html:checkbox property="localityUnincorporated" />UNINCORPORATED PLACE
                          </span>
                         </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            <fdms:speedselect property="deceasedCity2" category="CITY_STATE" column="1" combo="true" maxlength="50" size="1" textsize="14">
                              <fdms:linkoption text="Edit list..." script="tableWindow2('CITY_STATE',1,'forms[0].deceasedCity2',5,'forms[0].deceasedState',3,'forms[0].deceasedZipCode',4,'forms[0].deceasedCounty')"/>
                        ...
                        <tr>
                          <td height="28" align="right" valign="middle" class="verdana10"><strong><bean:message key="app.state"/></strong></td>
                          <td class="verdana10">
                            <fdms:speedselect property="deceasedState" category="States" column="1" combo="true" maxlength="20" size="1" textsize="14">
                              <fdms:linkoption text="Edit list..." script="tableWindow2('States',2,'forms[0].deceasedState')"/>
                            </fdms:speedselect>
                          </td>
                        </tr>
                        <tr>
                          <td height="28" align="right" valign="middle" class="verdana10"><strong><bean:message key="app.zip"/></strong></td>
                          <td class="verdana10">
                        ...
                        <tr>
                          ...
                          <td class="verdana10">
                            <fdms:speedselect property="deceasedCountry" category="Country" column="1" combo="true" maxlength="30" size="1" textsize="14">
                              <fdms:linkoption text="Edit list..." script="tableWindow2('Country',1,'forms[0].deceasedCountry')"/>
                            </fdms:speedselect>
                          </td>
                        </tr>  
                        <%--   
                        <tr>
                          <td width="49%" height="28" align="right" valign="middle" class="verdana10"><strong>LENGTH OF TIME RESIDING AT RESIDENCE</strong></td>
                          <td width="2%" rowspan="7">&nbsp;</td>
                          <td width="49%"><html:text maxlength="10" size="10" property="deceasedResLengthTime" /></td>
                        </tr>   
                        --%>
                     <tr>
                      <td width="49%" height="28" align="right" valign="middle" class="verdana10"><strong>Years at Resident address</strong></td>  
                       <td width="2%" rowspan="7">&nbsp;</td>
                      <td width="49%">
			            <html:select size="1" property="deceasedResLengthTime">
			            	<html:option value="no info">--Select--</html:option>
				            <html:option value="Under 5">Under 5</html:option>
				            <html:option value="5-9">5-9</html:option>
				            <html:option value="10-19">10-19</html:option>
				            <html:option value="20 or more">20 or more</html:option>
			            </html:select>
			          </td>
                    </tr>                       
                ...
                <tr align="left" valign="top">
                  <td height="28" class="verdana10"><fieldset><legend class="tahoma12bGreen">General History</legend>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="20" valign="bottom" class="verdana10"><strong>BIRTHPLACE (City and <bean:message key="app.state"/> or Foreign Country</strong></td>
                    </tr>
                    <tr>
                      <td height="28"><table border="0" cellpadding="0" cellspacing="0" style="font:10px Arial">
                        <tr>
                          ...
                          <td width="127" align="left" valign="middle" class="verdana10"><bean:message key="app.state"/>
                    ...
                    <tr>
        <td height="28" class="verdana10">Elementary/Secondary (0-12)<html:text size="3" property="deceasedElementaryEducation" />
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
 					...
 					<tr>
                      <td height="20" valign="bottom" class="verdana10"><strong>Citizenship</strong></td>
                    </tr>                   
                     <tr>
                      <td height="28">
                ...
                <tr align="left" valign="top">
                  <td height="28" class="verdana10"><fieldset><legend class="tahoma12bGreen">Occupational History</legend>
                    ...
                    <tr>
                      <td height="20" valign="bottom" class="verdana10"><strong>CURRENT EMPLOYER</strong></td>
                    </tr>
                    <tr>
                      <td height="28">
                  ...
                  <td class="verdana10"><fieldset><legend class="tahoma12bGreen">Marital Status</legend>
                    ...
                    <tr>
                      <td height="28">
                      <fdms:speedselect property="maritalStatus" category="Marital" column="1" combo="true" maxlength="50" size="1" textsize="30">
                      </fdms:speedselect>
                ...
                <tr>
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font:10px Arial">
                    <tr align="left" valign="bottom" class="verdana10">
                      <td height="20"><strong>First</strong></td>
                    ...
                    <tr align="left">
                      ...
                      <td colspan="3"><br /><strong>BIRTHPLACE (City and <bean:message key="app.state"/> or Foreign Country)</strong> </td>
                    </tr>
                     <tr>
                      <td colspan="3"><table border="0" cellpadding="0" cellspacing="0" style="font:10px Arial">
                        <tr>
                          <td align="left" valign="middle" class="verdana10"> City
                          ...
                          <td align="left" valign="middle" class="verdana10"><bean:message key="app.state"/>
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font:10px Arial">
                    <tr align="left" valign="bottom" class="verdana10">
                      ...
                      <td width="32%" height="20"><strong>First</strong></td>
                      <td width="17%"><strong>Middle</strong></td>
                      <td width="51%"><strong>Surname before first married</strong></td>
                    ...
                    <tr align="left">
                      <td> <strong>Maiden: </strong><br />
                          <html:text maxlength="50" size="11" property="motherMaidenName" />
                      </td>
                    </tr>                   
...
&nbsp;
      ...
      <tr>
        ...
        <td><fdms:speedselect name="vitals" property="informantRelation" category="Relation" combo="true" maxlength="20" size="1" textsize="25">
...
&nbsp;&nbsp;<bean:message key="app.zip"/>
  ...
  <fieldset><legend class="tahoma12bBlue">Disposition Information</legend>
      ...
      <tr>
        <td class="verdana10" height="20"><strong>DIRECTOR NAME, LICENSE NO.</strong>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="verdana10" height="20"><strong>EMBALMER NAME, LICENSE NO.</strong>
        </td>
      </tr>
      <tr>
        <td height="28"><html:select size="1" property="embalmerID">
                    ...
                    <tr>
                      <td height="28"><html:text maxlength="30" size="29" property="facilityStreet" /></td>
                    </tr>
                    <tr>
                      <td height="20" valign="bottom" class="verdana10"><strong>CITY</strong></td>
                    </tr>
                    <tr>
                      <td height="28">
                      	<fdms:speedselect property="facilityCity" category="CITY_STATE" column="1" combo="true" maxlength="50" size="1" textsize="40">
                          <fdms:linkoption text="Edit list..." script="tableWindow2('CITY_STATE',1,'forms[0].facilityCity')"/>
                        </fdms:speedselect>
                      </td>
                    </tr>
                    <tr>
                      <td height="28" class="verdana10" valign="top">
                      	<strong><bean:message key="app.state"/>:</strong>
                        <fdms:speedselect property="facilityState" category="States" column="2" combo="true" maxlength="25" 
                        	size="1" textsize="3"></fdms:speedselect>
                        <strong>&nbsp;&nbsp;&nbsp;<bean:message key="app.zip"/>:</strong>	
                      	<fdms:speedselect name="vitals" 
                  ...
                  <legend class="tahoma12bGreen">Method and Location</legend>
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                    ...
                    <tr>
                      <td height="20" valign="bottom" class="verdana10"><strong>LOCATION</strong> -
                        Street, City, or Village, <bean:message key="app.state"/>, County, zip</td>
                    </tr>
                    <tr>
                               <html:hidden property="dispositionPhone"/>
                      <td height="28"><html:text maxlength="30" size="30" property="dispositionStreet" />
                      </td>
                    </tr>
                    <tr>
                      <td height="28"><html:text maxlength="30" size="16" property="dispositionCity" />
						...
						<fdms:speedselect name="vitals" property="dispositionState" category="States" 
							column="2" combo="true" maxlength="19" size="1" textsize="6">
						</fdms:speedselect>
                      </td>
                    </tr>
                    <tr>
                      <td height="28" valign="bottom" class="verdana10"><html:text maxlength="30" size="16" property="dispositionCounty" />&nbsp;
                      <html:text maxlength="10" size="10" property="dispositionZipCode" />
						&nbsp;
                      </td>
                    </tr>
      <tr>
        <td height="20" class="verdana10"><strong>DATE EMBALMED</strong>
        </td>
      </tr>
      <tr>
        <td height="28"><html:text maxlength="15" size="10" property="dateEmbalmed" />
        <fdms:FDMSDate fieldID="dateEmbalmed1" javascriptFormField="document.forms[0].dateEmbalmed"></fdms:FDMSDate>
      ...
      <tr>
        <td height="28"><html:text maxlength="15" size="10" property="dateOfDisposition" />
      ...
      <tr>
        <td height="20" class="verdana10">If Cremation, specify name of authorizing M.E or Coroner
        </td>
      </tr>
      <tr>
        <td height="28">
          <fdms:speedselect property="authorizingCoroner" category="Doctor" column="1" combo="true" maxlength="49" size="1" textsize="30">
  ...
  <fieldset><legend class="tahoma12bBlue">Certification</legend>
                ...
                <tr>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td height="28" class="verdana10">Date ME Signed:
                        <html:text maxlength="17" size="17" property="medicalExaminerDateSigned" />
                  ...
                  <td width="49%" align="left" valign="top"><fieldset><legend class="tahoma12bGreen">Time of Death</legend>
                    ...
                    <tr>
                      ...
                      <html:text maxlength="10" size="10" property="timeOfDeath" onfocus="focusTimeEdit(this);" /> </td>
                    </tr>
                    <tr>
                      <td height="20" valign="bottom" class="verdana10"><strong>PRONOUNCED DEAD ON (Mo Day Yr)</strong></td>
                    </tr>
                    <tr>
                      <td height="28">
                    ...
                    <tr>
                      <td height="20" valign="bottom" class="verdana10"><strong>TIME PRONOUNCED</strong></td>
                    </tr>
                    <tr>
                      <td height="28" class="verdana12">
            ...
            <html:option value="No"><bean:message key="option.no"/></html:option>
                ...
                <tr align="left" valign="top">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td>
                        <fdms:speedselect property="attendingPhysician" category="Doctor" column="1" combo="true" 
                        	size="1" textsize="38">
                ...
                <tr align="left" valign="top">
                  <td colspan="3">
                  	<fieldset>
                  	<legend class="tahoma12bGreen">Name and Address of Certifying Physician</legend>
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="49%" height="28" align="right" valign="middle" class="verdana10">
                      	<strong>NAME</strong>
                      </td>
                      <td width="2%">&nbsp;</td>
                      <td width="49%">
                        <fdms:speedselect property="completedCauseOfDeathDoctorName" category="Doctor" column="1" 
                        	combo="true" maxlength="50" size="1" textsize="46">
                    ...
                    <tr>
                      ...
                      <td class="verdana10">
	                    <fdms:speedselect name="vitals" property="completedCauseOfDeathDoctorState" category="States" 
							column="1" combo="true" maxlength="15" size="1" textsize="15">
	  					</fdms:speedselect>
                    ...
                    <tr>
                      ...
                      <td>&nbsp;</td>
                      <td><html:text maxlength="15" size="15" property="completedCauseOfDeathDoctorPhone" />
                      <script type="text/javascript">oPhoneMask.attach(document.forms[0].completedCauseOfDeathDoctorPhone);</script></td>
                    </tr>

      <tr>
        <td height="28" align="right" valign="middle" class="verdana10"><strong>PHYSICIAN / CERTIFIER TITLE</strong>
        </td>
                      <td>&nbsp;</td>
        <td class="verdana12"><html:checkbox property="physicianMD" />M.D.
        <html:checkbox property="physicianME" />Coroner/M.E.
        <html:checkbox property="physicianDO" />D.O.
        <html:checkbox property="physicianHO" />Health Officer
        </td>
      </tr>
      <tr>
        <td height="28" align="right" valign="middle" class="verdana10"><strong>DATES PHYSICIAN ATTENDED THE DECEASED</strong>
        </td>
                      <td>&nbsp;</td>
        <td class="verdana12">
              From Date: <html:text maxlength="10" size="10" property="physDateFrom" />
              
              <fdms:FDMSDate fieldID="physDateFrom1" javascriptFormField="document.forms[0].physDateFrom"></fdms:FDMSDate>
              
          <br>To Date: <html:text maxlength="10" size="10" property="physDateTo" />
          	  <fdms:FDMSDate fieldID="physDateTo1" javascriptFormField="document.forms[0].physDateTo"></fdms:FDMSDate>
          	  
          <br>Last Date: <html:text maxlength="10" size="10" property="physDateLast" />
          	  <fdms:FDMSDate fieldID="physDateLast1" javascriptFormField="document.forms[0].physDateLast"></fdms:FDMSDate>
          	  	
        </td>
      </tr>
      <tr>
        <td height="28" align="right" valign="middle" class="verdana10"><strong>PHYSICIAN VIEWED THE BODY</strong>
        </td>
                      <td>&nbsp;</td>
        <td>
                      ...
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td height="28" class="verdana10"><strong>(Mo/Day/Yr)</strong> 
                          	<html:text readonly="true" maxlength="17" size="15" property="registrarFileDate"  />
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td width="30%" rowspan="7" align="left" valign="top" class="verdana10"><br>
                    ...
                    as appropriate.<br>
                    <br>IMMEDIATE CAUSE (Final disease or condition resulting in death)<br>
                    <br>Sequentially list conditions IF ANY leading to immediate cause. Enter UNDERLYING CAUSE (Disease or injury that initiated events resulting in death) LAST</td>
                ...
                <tr>
                  <td align="left" valign="top" class="verdana10"><html:text maxlength="49" size="49" property="cause1" />
                    <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; DUE TO (OR AS A CONSEQUENCE OF)</td>
    ...
    <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="250" height="40" align="right" valign="top">
          ...
          <html:image alt="Save" src="images-old/buttonsave.gif" onclick="set('save');" />
          <html:image alt="Cancel" src="images-old/buttoncancel.gif" onclick="cancelAll('cancel')" />
          <html:image alt="?Help" src="images-old/buttonhelp.gif" onclick="set('cancel')" />
          </fieldset>
        </td>
      </tr>
    </table>
