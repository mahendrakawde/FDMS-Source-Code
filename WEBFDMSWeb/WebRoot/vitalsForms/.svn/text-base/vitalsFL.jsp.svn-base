			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<fieldset><legend class="tahoma12bMaroon">Actions</legend> <html:image
						...
						onclick="formConfirmOff();set('save');" />
				...
				<tr align="left" valign="top">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td><fdms:speedselect property="deceasedCity2" category="County"
						...
						<tr>
							<td height="28" align="right" valign="middle" class="verdana10"><strong>ZIP</strong></td>
							<td>
						...
						<tr>
							...
							<table border=0 cellpadding=0 cellspacing="0"
								...
								<tr>
									...
									<td width="127" align="left" valign="middle" class="verdana10">State
									<fdms:speedselect property="birthplaceState"
										category="States" column="2" combo="true" maxlength="25"
										size="1" textsize="3"
										onblur="javascript:formatStateProvince();">
									</fdms:speedselect></td>
								</tr>
							</table>
							</td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<fdms:speedselect property="maritalStatus"
									category="Marital" column="1" combo="true" maxlength="50"
									size="1" textsize="30">
							</fdms:speedselect>
				...
				<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td height="28"> <html:text maxlength="15" size="15"	property="facilityLicenseNumber" /> </td>
						</tr>
						<tr>
						...
						<tr>
							<td height="28"><html:text maxlength="30" size="16"
								...
								<fdms:speedselect name="vitals" property="dispositionState" category="States" 
									column="2" combo="true" maxlength="20" size="1" textsize="6">
								</fdms:speedselect>
							</td>
						</tr>
						<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="49%">
								...
								column="1" combo="true" maxlength="150" size="1" textsize="38">
								<fdms:linkoption text="Edit list..."
						...
						<tr>
							...
							<td><html:text maxlength="15" size="15"
								property="completedCauseOfDeathDoctorPhone" /></td>
						</tr>
						<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td class="verdana10"><html:text maxlength="20" size="22"
								property="medicalExaminerInjuryCity" /> &nbsp;<strong>STATE</strong>
		...
		<tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<fieldset><legend class="tahoma12bMaroon">Actions</legend> <html:image
						alt="Save" src="images-old/buttonsave.gif"
						onclick="formConfirmOff();set('save');" /> <html:image
