...
<IMG src="images-old/popup.gif" BORDER=0></A>
  ...
  <p>
  InvImage test:<input type="text" name="picture" size="30" value="logo.gif" onBlur="document.mypic.src= forms[0].picture.value;" onChange="document.mypic.src= forms[0].picture.value;">
  <A HREF="javascript:speedData();" onBlur="document.mypic.src= forms[0].picture.value;" onmouseover="window.status='Click to view list of images-old'; return true;" onmouseout="window.status='';" onClick="tableWindow2('Invimages-old',1,'forms[0].picture');"><IMG src="images-old/popup.gif" BORDER=0/></A>
  <br>
