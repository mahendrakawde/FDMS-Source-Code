...
<head>
   <LINK REL="SHORTCUT ICON" HREF="http://dev.webfdms.com/dlogomult.ico">
...
//-->
			...
			<table border="1" width="100%">
		       <tr>
			      <td align="center" bgcolor="lightblue">
			         <b><i><font face="Arial" size="3">New to WebFDMS</font></i></b>
			      </td>
		       </tr>
		       <tr>
			      <td>
				     <table border="0">
						<tr>
						   <td align="right">
						      <html:radio property="loginOption" value="freeTrial" onclick="setLoginOption();" />
						   </td>
						   <td align="left">
						      <b><font face="Arial" size="2">Setup a Free 30-Day Trial Membership</font></b>
						   </td>
						</tr>
						<tr>
						   <td align="right">
						      <html:radio property="loginOption" value="guest" onclick="setLoginOption();" />
						   </td>
						   <td align="left">
						      <b><font face="Arial" size="2">Be our Guest</font></b>
						   </td>
						</tr>
						<tr>
						   <td align="right">
						      <html:radio property="loginOption" value="membership" onclick="setLoginOption();" />
						   </td>
						   <td align="left">
						      <b><font face="Arial" size="2">Purchase Membership</font></b>
						   </td>
						</tr>
						<tr>
						   <td align="right">
						      <html:radio property="loginOption" value="abbit" onclick="setLoginOption();" />
						   </td>
						   <td align="left">
						      <b><font face="Arial" size="2">Sign up for Abbit On-Line Pre-Need</font></b>
						   </td>
						</tr>
						<tr>
						   <td colspan="2" align="center">
						      <html:image alt="Submit" src="images-old/buttonsubmit.gif" onclick="setLoginOption();setSubmit(document.forms[0].loginOption.value);" />
						   </td>
						</tr>
					 </table>
			      </td>
