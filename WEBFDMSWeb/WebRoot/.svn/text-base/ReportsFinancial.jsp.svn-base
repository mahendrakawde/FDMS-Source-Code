...
-->            <p align="left" style="line-height: 100%; margin-bottom: -16" />
            <b><i><font face="Arial Narrow" color="#000080" size="6">&quot;Financial
			...
			<!--<applet code="fphover.class"  width="80" height="40">
              ...
              <param name="url" valuetype="ref" value="Financial.htm">
            </applet>  -->
  ...
  <table border="0" width="100%" height="208">
    <tr>
      <td width="100%" colspan="2" height="48">
        ...
        a report...&nbsp; </b></i></font>
        <html:select property="D1" style="font-family: Arial; font-size: 12pt">
          <html:option value="">Detailed Sales Report</html:option>
          <html:option value="">Statements</html:option>
          <html:option value="">Aging by Location</html:option>
          <html:option value="">Aging by Director</html:option>
          <html:option value="">Cash Receipts Journal</html:option>
          <html:option value="">Discounts by Director</html:option>
        </html:select></td>
    </tr>
    <tr>
...
<p align="center" style="line-height: 100%">
			...
			<html:link forward="Generate Reports" onclick="formConfirmOff();">
				<html:img alt="Generate Reports" src="images-old/buttongeneratereports.gif" />
			</html:link>
			&nbsp; </p>
