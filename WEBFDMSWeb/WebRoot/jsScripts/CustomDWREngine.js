...
/**
 * A structure to contain callback information
 * @private
 */
...
{
    var func = DWREngine._callbacks[id].func;
    var name = DWREngine._callbacks[id].name;

    // Clear this callback out of the list - we don't need it any more
    DWREngine._callbacks[id].func = null;
    DWREngine._callbacks[id].name = null;
 ...
 * This method is called by Javascript that is emitted by server
 * $param objName The name or id of the related HTML field
 ...
 * @private
 */
DWREngine._execute = function(objName, path, scriptName, methodName, vararg_params)
{
    ...
    DWREngine._callbacks[id] = new CallbackInfo();
    DWREngine._callbacks[id].func = func;
    DWREngine._callbacks[id].name = objName;
