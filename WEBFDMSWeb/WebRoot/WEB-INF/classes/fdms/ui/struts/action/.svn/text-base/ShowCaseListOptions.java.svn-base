...
public class ShowCaseListOptions extends Action {
    
    private Logger logger = Logger.getLogger(ShowCaseListOptions.class.getName());
    ...
    public ActionForward execute(
        ...
        logger.debug("*** Entering ShowCaseListOptions ***");
