...
public class QBWebConnectorSvcLocator extends org.apache.axis.client.Service implements com.aldorsolutions.webfdms.webservice.QBWebConnectorSvc {
    ...
    public com.aldorsolutions.webfdms.webservice.QBWebConnectorSvcSoap getQBWebConnectorSvcSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.aldorsolutions.webfdms.webservice.QBWebConnectorSvcSoap getQBWebConnectorSvcSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.aldorsolutions.webfdms.webservice.QBWebConnectorSvcSoapStub _stub = new com.aldorsolutions.webfdms.webservice.QBWebConnectorSvcSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.aldorsolutions.webfdms.webservice.QBWebConnectorSvcSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.aldorsolutions.webfdms.webservice.QBWebConnectorSvcSoapStub _stub = new com.aldorsolutions.webfdms.webservice.QBWebConnectorSvcSoapStub(new java.net.URL(QBWebConnectorSvcSoap_address), this);
                _stub.setPortName(getQBWebConnectorSvcSoapWSDDServiceName());
                return _stub;
            }
        }
