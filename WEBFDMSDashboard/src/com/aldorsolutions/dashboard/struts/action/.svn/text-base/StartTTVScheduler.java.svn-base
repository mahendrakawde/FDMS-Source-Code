...
import com.aldorsolutions.webfdms.reporting.TTVSchedulerTask;
 ...
 *                validate="true"
 */
public class StartTTVScheduler extends Action {
	Logger logger = Logger.getLogger(StartTTVScheduler.class);
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        Timer ttvTimer = new Timer("TTVThread", true);
		ttvTimer.schedule(TTVSchedulerTask.getInstance(), 10);
