 ...
 */
public class UnderDevelopmentAction extends Action {
	/*
	 * Generated Methods
	 */
	
	private Logger logger = Logger.getLogger(UnderDevelopmentAction.class.getName());
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		return ( mapping.findForward("underDevelopmentPage") );
	}
