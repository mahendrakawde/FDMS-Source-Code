...
<div id="navigation_container">
	<div id="navigation">
		<ul id="nav_elements">
			...
			<!-- HOME -->
			<li class="level_one invoices"><a href="showMain.do">File</a>
			<ul class="reportSlide">
							<li class="level_two bottomBorder"><a href="showMain.do" >Home</a><hr/>
							</li>
							<li class="level_two bottomBorder"><a href="userLogout.do"  >Logout</a>
							</li>
							</ul>
			</li>
			...
			<companyOption:enabled
				...
				<c:if test="${sessionScope.permissions.dashboardReportGranted}">
					<!-- REPORT -->
					<li class="level_one report"><a href="showReport.do?type=R">Reports</a>
						<ul class="reportSlide">
			...
			<companyOption:enabled
				...
				<!-- SMS -->
				<li class="level_one sms"><a href="sendTextToSpeech.do">TTV</a>
					<ul class="reportSlide">
						<li class="level_two bottomBorder"><a
			...
			<!-- MY ACCOUNT -->
			<li class="level_one myaccount"><a href="myAccount.do">My Account</a>
			</li>

			<!-- Chart List -->
			<companyOption:enabled
				optionValue="<%= String.valueOf(com.aldorassist.webfdms.model.CompanyOptionsDTO.COMPANY_OPTION_TURN_ON_DASHBOARD_ANALYTICS) %>">
				<li class="level_one chart"><a href="chartList.do"> Analytics </a></li> 
			</companyOption:enabled>
