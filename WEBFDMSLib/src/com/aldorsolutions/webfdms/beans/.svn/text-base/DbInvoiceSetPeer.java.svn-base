 ...
 * @author:
 */
public class DbInvoiceSetPeer extends com.aldorsolutions.webfdms.database.DatabaseSetPeer {
	/**
	...
	public String getPersistentClass(java.util.Hashtable h) {
		return "com.aldorsolutions.webfdms.beans.DbInvoice";
	}
	...
	public String getSql(java.util.Hashtable h) {
		if (h == null) {
			...
			tmp.append("SELECT * FROM invoice where (LocaleID=0");
