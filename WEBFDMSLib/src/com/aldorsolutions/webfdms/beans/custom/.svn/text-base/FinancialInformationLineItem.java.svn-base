 ...
 * @version
 */
public class FinancialInformationLineItem extends java.lang.Object {
	...
	private String[] serialSelectedNumbers;
	...
	public boolean postedToTran; 

	/**
	 * @return the postedToTran
	 */
	public boolean isPostedToTran() {
		return postedToTran;
	}

	/**
	 * @param postedToTran the postedToTran to set
	 */
	public void setPostedToTran(boolean postedToTran) {
		this.postedToTran = postedToTran;
	}
	...
	public FinancialInformationLineItem() {
	}

	public FinancialInformationLineItem(DbChargeItem dbChargeItem) {
	...
	public String getItemNameWithoutSpace() {
		return dbChargeItem.getInvItemName().replaceAll(" ", "");
	}
	...
	public String[] getSerialSelectedNumbers() {
		return serialSelectedNumbers;
	}

	public void setSerialSelectedNumbers(String[] serialSelectedNumbers) {
		this.serialSelectedNumbers = serialSelectedNumbers;
	}
