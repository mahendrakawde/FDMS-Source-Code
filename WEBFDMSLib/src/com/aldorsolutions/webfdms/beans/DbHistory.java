...
public class DbHistory  extends com.aldorsolutions.webfdms.database.Persistent {
    ...
    public void restore(Transaction t, java.util.Hashtable data) throws PersistenceException {
        ...
        /* Code added by Jigar for Ticket# 5572 -Date Time Stamp issue / bug  on Payment Screen*/
        if(data.get(DbHistoryPeer.DATETIMEOFTRANS) instanceof java.sql.Timestamp)
        	setDatetimeOfTrans (((java.sql.Timestamp)data.get(DbHistoryPeer.DATETIMEOFTRANS)).getTime());
        else
