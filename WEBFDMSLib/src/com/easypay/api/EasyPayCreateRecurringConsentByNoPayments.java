 ...
 *         &lt;element name="TTL_Amount" type="{http://www.w3.org/2001/XMLSchema}float"/>
 *         &lt;element name="No_Payments" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *         &lt;element name="Last_Payment" type="{http://www.w3.org/2001/XMLSchema}float"/>
...
@XmlRootElement(name = "EasyPay_CreateRecurringConsentByNoPayments")
public class EasyPayCreateRecurringConsentByNoPayments {
    ...
    @XmlElement(name = "TTL_Amount")
    protected float ttlAmount;
    @XmlElement(name = "No_Payments")
    ...
    /**
     * Gets the value of the ttlAmount property.
     * 
     */
    public float getTTLAmount() {
        return ttlAmount;
    }

    /**
     * Sets the value of the ttlAmount property.
     * 
     */
    public void setTTLAmount(float value) {
        this.ttlAmount = value;
    }
