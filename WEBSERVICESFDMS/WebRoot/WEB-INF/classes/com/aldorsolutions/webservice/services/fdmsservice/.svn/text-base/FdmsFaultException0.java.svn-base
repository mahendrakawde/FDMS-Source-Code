...
public class FdmsFaultException0 extends java.lang.Exception {

	private com.aldorsolutions.webservice.services.fdmsservice.FdmsFault faultMessage;

	public FdmsFaultException0() {
		super("FdmsFaultException0");
	}

	public FdmsFaultException0(java.lang.String s) {
		super(s);
	}

	public FdmsFaultException0(java.lang.String s, java.lang.Throwable ex) {
		super(s, ex);
	}
